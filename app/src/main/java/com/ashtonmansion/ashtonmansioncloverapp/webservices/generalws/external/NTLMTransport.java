package com.ashtonmansion.ashtonmansioncloverapp.webservices.generalws.external;
...
public class NTLMTransport extends Transport {
     ...
     * Use either {@link (String)} or {@link (String, int)} instead.
     */
    @Deprecated
     ...
     * Use a combination of a {@link (String)} constructor to set the service url and
    ...
    public List call(String soapAction, SoapEnvelope envelope, List headers, File outputFile)
        ...
        if (response.getStatusLine().getStatusCode() == 401) {
            Log.e("Unauthorized", response.toString());
        }
     ...
     * {@link (String)} constructor and set your credentials with the
